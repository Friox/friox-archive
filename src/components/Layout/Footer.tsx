    ...
    <Box css={footerWrapperStyle}>
      <Container maxW='6xl' direction='row'>
        <Stack justifyContent='space-between' direction='row'>
          <Stack>
            <Text fontSize='sm'>Friox Archive., Powered by Gatsby and <Link variant='underline' href='https://github.com/Friox/gatsby-starter-friox'>gatsby-starter-friox</Link></Text>
